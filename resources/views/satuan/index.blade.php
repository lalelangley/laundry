...
<div class="w-full bg-yellow-400 p-4 flex items-center">
    ...
    <h1 class="text-xl font-bold">Kelola Satuan</h1>
</div>
...
<div class="p-4 bg-gray-100 min-h-screen">
    ...
    <div id="satuanList">
        @foreach($satuan as $s)
        <div class="satuan-item bg-white p-4 mb-3 flex items-center rounded-xl shadow">
            <span class="text-3xl mr-3">⚖️</span>

            <p class="nama font-semibold flex-1">{{ $s->nama_satuan }}</p>

            <a href="{{ route('satuan.edit', $s->id_satuan) }}" class="text-blue-500 text-xl mr-3">
