    ...
    <div class="px-6 py-8 max-w-7xl mx-auto">
        ...
        <div class="profile-card rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div class="profile-header-bg px-8 py-6 relative">
                <div class="relative z-10 flex items-center gap-6">
                    ...
                    <div class="flex-1">
                        <h2 class="text-2xl font-bold text-gray-800 mb-1">{{ $admin->nama }}</h2>
                        <div class="flex items-center gap-3">
                            <div class="flex items-center gap-2 text-gray-700">
                                <i class="bi bi-envelope-fill text-yellow-600 drop-shadow"></i>
                                <span class="font-semibold text-sm">{{ $admin->email }}</span>
                            </div>
            ...
            <div class="p-8">
                {{-- ALERTS --}}
                @if(session('success'))
                <div class="alert-success px-6 py-4 rounded-2xl mb-6 flex items-center gap-3">
                ...
                @if($errors->any())
                <div class="alert-error px-6 py-4 rounded-2xl mb-6">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            <p class="font-bold text-red-800 mb-1">Terjadi Kesalahan!</p>
                            <ul class="space-y-1">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div class="section-card rounded-2xl p-6">
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    <label class="block text-sm font-bold text-gray-700 mb-2">
                                        <i class="bi bi-envelope-fill text-yellow-600 mr-1"></i>
                                        Alamat Email
                                    </label>
                                    <div class="relative">
                                        <i class="bi bi-envelope-fill absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 text-lg"></i>
                                        <input type="email" 
                                               name="email"
        ...
        <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="bg-white rounded-2xl p-5 shadow-lg tips-card">
                <div class="flex items-center gap-4">
                    <div class="icon-yellow w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0">
                        <i class="bi bi-envelope-check text-white text-2xl"></i>
                    </div>
                    <div>
                        <h4 class="font-bold text-gray-800 text-sm mb-1">Email Valid</h4>
