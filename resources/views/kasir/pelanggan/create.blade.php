...
<div class="px-5 py-6">
   ...
   <form action="{{ request('from') === 'transaksi' ? route('kasir.transaksi.pelanggan.store') : route('kasir.pelanggan.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
    @csrf
