{{-- FE-DOC: Template frontend untuk resources/views/kasir/pesanan_online/bukti_pembayaran.blade.php. Tambahan komentar di file ini dipakai sebagai penjelas struktur Blade, Tailwind, CSS, dan JavaScript tanpa mengubah behavior. --}}
...
<div class="min-h-screen bg-gray-50 pb-10">
    ...
    <div class="max-w-7xl mx-auto px-6 py-6">
        ...
        <div class="bg-white rounded-xl shadow p-6">
            ...
            <form action="{{ route('kasir.pesanan.online.simpan-bukti-pembayaran', $pesanan->id_transaksi) }}" 
                method="POST" 
                ...
                <div class="flex gap-3">
                    <a href="{{ route('kasir.pesanan.online.detail', $pesanan->id_transaksi) }}"
