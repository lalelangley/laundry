{{-- FE-DOC: Template frontend untuk resources/views/kasir/pesanan_online/listonlinedriver.blade.php. Tambahan komentar di file ini dipakai sebagai penjelas struktur Blade, Tailwind, CSS, dan JavaScript tanpa mengubah behavior. --}}
@extends('layouts.master')

@section('title', 'Pilih Driver Online')
...
<div class="bg-yellow-400 px-5 py-5 rounded-b-3xl flex items-center gap-3 shadow-lg">
    <a href="{{ route('kasir.pesanan.online.detail', $pesanan->id_transaksi) }}" class="text-black text-3xl font-bold">
...
<div id="catatanModal" class="fixed inset-0 bg-black/50 z-50 hidden flex items-end sm:items-center justify-center">
    <div class="bg-white w-full sm:max-w-lg rounded-t-3xl sm:rounded-2xl p-6 transform transition-all">
        ...
        <form id="assignDriverForm" 
              action="{{ $isPickup ? route('kasir.pesanan.online.assign-driver-pickup', $pesanan->id_transaksi) : route('kasir.pesanan.online.assign-driver-antar', $pesanan->id_transaksi) }}" 
              method="POST"
