{{-- FE-DOC: Template frontend untuk resources/views/kasir/pesanan_online/detail.blade.php. Tambahan komentar di file ini dipakai sebagai penjelas struktur Blade, Tailwind, CSS, dan JavaScript tanpa mengubah behavior. --}}
...
<div id="isiDataModal"
    ...
    <div class="bg-white rounded-2xl max-w-3xl w-full shadow-2xl max-h-[90vh] overflow-hidden flex flex-col"
        ...
        <div class="overflow-y-auto flex-1 px-6 py-6">
            <form action="{{ route('kasir.pesanan.online.updateData', $pesanan->id_transaksi) }}" method="POST" enctype="multipart/form-data" id="formIsiData">
            @csrf
            @method('PUT')
...
function sendNotificationSelesaiDicuci() {
    ...
    fetch('{{ route("kasir.pesanan.online.send-fcm-notification", $pesanan->id_transaksi) }}', {
        method: 'POST',
        headers: {
