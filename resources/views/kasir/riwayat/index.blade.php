        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5">
            @forelse ($riwayat as $t)
                <div class="group relative">
                    <a href="{{ route('kasir.riwayat.detail', $t->id_transaksi) }}" class="block">
                        <div class="relative bg-white shadow-lg rounded-2xl p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-l-4
                            ...
                            @elseif($t->status_transaksi=='pick_up') border-purple-500
                            @elseif($t->status_transaksi=='siap_di_ambil') border-teal-500
                            @elseif($t->status_transaksi=='siap_di_antar') border-indigo-500
                            ...
                            <div class="bg-gradient-to-r from-yellow-400 to-yellow-500 text-gray-900 px-4 py-3 rounded-xl mb-4 shadow-md">
                                ...
                                <p class="text-2xl font-bold">Rp {{ number_format($t->total_harga,0,',','.') }}</p>
                            </div>
                            ...
                            <div class="mt-4 pt-4 border-t-2 border-gray-100 flex flex-wrap gap-2">
                                ...
                                @elseif ($t->status_bayar == 'DP')
                                    <span class="inline-flex items-center gap-1 px-3 py-1.5 bg-yellow-400 text-gray-800 rounded-lg text-xs font-semibold">
                            ...
                            <div class="mt-4 flex flex-wrap gap-2">
                                ...
                                @if(!in_array($t->status_transaksi, ['selesai','batal']))
                                    <a href="{{ route('kasir.riwayat.batal', $t->id_transaksi) }}"
                                       class="px-4 py-2 bg-red-500 text-white rounded-lg shadow hover:bg-red-600">Batal</a>
                                @endif
                            </div>
