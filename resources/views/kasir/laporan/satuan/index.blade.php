    ...
    <div class="sticky top-0 z-20 bg-yellow-400 shadow-md">
        <div class="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-5 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
            <div class="flex items-center gap-4">
                <a href="{{ route('kasir.laporan.index') }}" class="text-2xl font-bold text-gray-900 transition hover:opacity-80">
                    <i class="bi bi-arrow-left"></i>
                </a>
                <div>
                    <h1 class="text-xl font-bold text-gray-900 lg:text-2xl">Laporan Satuan</h1>
                    <p class="text-sm text-gray-700">Komponen desktop dibuat sama dengan halaman laporan lain.</p>
                </div>
            </div>
            <div class="rounded-full bg-white/40 px-4 py-2 text-sm font-semibold text-gray-800">
                View only
            </div>
        </div>
    </div>
    ...
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        <form method="GET" class="rounded-3xl bg-white p-4 shadow-sm ring-1 ring-black/5 lg:p-5">
            <div class="grid grid-cols-1 gap-4 xl:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_220px_56px] xl:items-end">
                ...
                <a href="{{ route('kasir.laporan.satuan.index') }}" class="inline-flex h-12 items-center justify-center rounded-2xl bg-gray-100 text-gray-600 transition hover:bg-gray-200" title="Reset Filter">
        ...
        <div class="mt-6 overflow-hidden rounded-3xl bg-white shadow-sm ring-1 ring-black/5">
            <div class="border-b border-gray-100 px-5 py-4">
                ...
                <p class="text-sm text-gray-500">Pola tampilan dibuat sama supaya halaman laporan tidak beda-beda.</p>
            </div>
