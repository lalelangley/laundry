...
<form method="GET" id="filterForm" class="px-5 md:px-6 mt-6 space-y-4">
    ...
    <div class="flex flex-col gap-3 xl:flex-row xl:items-center">
        ...
        <select name="sort"
                id="sort"
                class="bg-white rounded-full px-4 py-3 font-semibold shadow outline-none w-full sm:w-auto">
...
<div class="px-5 md:px-6 mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
    ...
    <div class="bg-white rounded-xl p-4 shadow border-2 border-orange-400">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <div class="text-base sm:text-lg font-bold text-orange-600 break-words">
...
<div class="px-5 md:px-6 mt-6">
    {{-- Tabel dibuat pakai grid 3 kolom agar layout tetap rapi di mobile --}}
    <div class="bg-white rounded-xl overflow-hidden shadow">
        <div class="overflow-x-auto">
        <div class="grid min-w-[640px] grid-cols-3 bg-yellow-400 text-center font-bold text-white py-3 border-b border-yellow-500">
        ...
        @forelse ($pengeluaran as $p)
            <div class="grid min-w-[640px] grid-cols-3 bg-white text-center py-4 border-b hover:bg-gray-50 transition-all text-sm">
                <div class="text-gray-700 font-semibold px-2">
                    {{ \Carbon\Carbon::parse($p->tanggal_pengeluaran)->format('d/m/Y') }}
                </div>
                <div class="font-semibold text-gray-800 px-2 break-words">
                    {{ $p->nama_pengeluaran }}
                </div>
                <div class="font-bold text-orange-600 px-2 break-words">
...
<div class="px-5 md:px-6 mt-4 pb-32">
    {{ $pengeluaran->links() }}
</div>
@endif
</div>
