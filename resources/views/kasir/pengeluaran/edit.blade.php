{{-- FE-DOC: Template frontend untuk resources/views/kasir/pengeluaran/edit.blade.php. Tambahan komentar di file ini dipakai sebagai penjelas struktur Blade, Tailwind, CSS, dan JavaScript tanpa mengubah behavior. --}}
