{{-- FE-DOC: Template frontend untuk resources/views/admin/edit_jenis_layanan.blade.php. Tambahan komentar di file ini dipakai sebagai penjelas struktur Blade, Tailwind, CSS, dan JavaScript tanpa mengubah behavior. --}}
...
<div class="bg-yellow-400 px-5 py-4 rounded-b-3xl flex items-center gap-3 shadow sticky top-0 z-10">
    ...
    @endphp
    <a href="{{ route('layanan.edit', ['id' => $idLayanan]) }}" class="text-black text-3xl font-bold hover:scale-110 transition-transform">
...
<div class="px-5 mt-6 pb-8">
    ...
    <form action="{{ isset($jenis) ? route('layanan.jenis.update', $jenis->id_jenis_layanan) : route('layanan.jenis.store', $idLayanan) }}" 
          method="POST" 
        ...
        <div class="flex gap-3 pt-4">
            <a href="{{ route('layanan.edit', ['id' => $idLayanan]) }}"
