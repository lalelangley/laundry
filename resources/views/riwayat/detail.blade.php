                       ...
                       @foreach($detail as $item)
                            <div class="flex justify-between items-center gap-4 p-5 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors border border-gray-200">
                                <div class="flex-1 space-y-2">
                                    ...
                                    {{-- Button Edit Layanan --}}
                                    <a href="{{ route('riwayat.edit_layanan', $item->id_detail) }}" 
                                        class="inline-block mt-2 px-4 py-2 bg-yellow-400 hover:bg-yellow-500 text-white font-bold rounded-xl shadow-md hover:shadow-lg transition-all">
