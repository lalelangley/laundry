{{-- FE-DOC: Template frontend untuk resources/views/pesanan_online/index.blade.php. Tambahan komentar di file ini dipakai sebagai penjelas struktur Blade, Tailwind, CSS, dan JavaScript tanpa mengubah behavior. --}}
...
<form id="deleteForm{{ $p->id_transaksi }}" 
      action="{{ route('pesanan.online.destroy', $p->id_transaksi) }}" 
      method="POST" 
      style="display: none;">
    @csrf
    @method('DELETE')
