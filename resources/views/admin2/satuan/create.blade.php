{{-- FE-DOC: Template frontend untuk resources/views/admin2/satuan/create.blade.php. Tambahan komentar di file ini dipakai sebagai penjelas struktur Blade, Tailwind, CSS, dan JavaScript tanpa mengubah behavior. --}}
...
<div class="p-4 bg-white min-h-screen">
    ...
    <form action="{{ route('admin2.satuan.store') }}" method="POST">
        @csrf
