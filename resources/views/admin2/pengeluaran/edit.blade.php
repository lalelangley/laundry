{{-- FE-DOC: Template frontend untuk resources/views/admin2/pengeluaran/edit.blade.php. Tambahan komentar di file ini dipakai sebagai penjelas struktur Blade, Tailwind, CSS, dan JavaScript tanpa mengubah behavior. --}}
