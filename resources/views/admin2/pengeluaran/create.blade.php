{{-- FE-DOC: Template frontend untuk resources/views/admin2/pengeluaran/create.blade.php. Tambahan komentar di file ini dipakai sebagai penjelas struktur Blade, Tailwind, CSS, dan JavaScript tanpa mengubah behavior. --}}
...
<div class="p-5 pb-[160px] space-y-6">
    ...
    <form action="{{ route('admin2.pengeluaran.store') }}" method="POST">
        @csrf
