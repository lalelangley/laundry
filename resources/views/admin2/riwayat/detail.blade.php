        ...
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 lg:col-span-4 space-y-6">
                ...
                <div class="space-y-3">
                    ...
                    <form id="formBatal" action="{{ route('admin2.riwayat.batal', $transaksi->id_transaksi) }}" method="POST">
                        @csrf
                        @method('PATCH')
                    ...
                    {{-- Hapus --}}
                    <form id="formHapus" action="{{ route('admin2.riwayat.destroy', $transaksi->id_transaksi) }}" method="POST">
                        @csrf
                        @method('DELETE')
...
function prosesSubmitPembayaran(jumlahBayar) {
    ...
    fetch("{{ route('admin2.riwayat.bayar.submit', $transaksi->id_transaksi) }}", {
        method: 'POST',
        body: formData,
        headers: {
