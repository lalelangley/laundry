    ...
    <div class="min-h-screen bg-gray-50 pb-24">
        ...
        <div class="px-8 py-6 space-y-6">
            ...
            {{-- TAMBAH --}}
            <a href="{{ route('admin2.layanan_create', ['from'=>'transaksi']) }}"
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        // ================= KLIK LAYANAN =================
            ...
            card.addEventListener('click', (e) => {
                ...
                // kalau klik jenis → biarin handler jenis yang jalan
        ...
        document.querySelectorAll('.jenis-item').forEach(item => {
            item.addEventListener('click', e => {
                ...
                console.log('🔥 Jenis diklik:', namaJenis, '| From:', from);

                // ✅ Selalu buka modal kalau from = transaksi atau riwayat
                if (from === "transaksi" || from === "riwayat") {
                    const riwayatId = "{{ request('id_transaksi') }}";
                    openModal(namaJenis, idJenis, from, riwayatId || null);
                } else {
                    // Dashboard atau lainnya → redirect ke edit
                    window.location.href = `/admin2/layanan/${idJenis}/edit`;
                }
            });
        });
