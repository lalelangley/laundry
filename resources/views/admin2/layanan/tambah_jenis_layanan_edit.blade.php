...
<div class="bg-yellow-400 px-5 py-4 rounded-b-3xl flex items-center gap-3 shadow">
    <a href="{{ route('admin2.layanan.edit', $from ?? 0) }}" class="text-black text-3xl font-bold">←</a>
...
<div class="px-5 mt-6">
    ...
    {{-- FORM TAMBAH --}}
<form action="{{ route('admin2.layanan.jenis.add.edit', $from) }}" method="POST" enctype="multipart/form-data">
        @csrf
