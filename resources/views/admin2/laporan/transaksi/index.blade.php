{{-- FE-DOC: Template frontend untuk resources/views/admin2/laporan/transaksi/index.blade.php. Tambahan komentar di file ini dipakai sebagai penjelas struktur Blade, Tailwind, CSS, dan JavaScript tanpa mengubah behavior. --}}
...
{{-- FE-DOC: Header halaman dipakai untuk judul modul, navigasi balik, dan kadang tombol export cepat. --}}
    ...
    {{-- FORM FILTER --}}
    <form method="GET" action="{{ route('admin2.laporan.transaksi.index') }}" id="filterForm" class="px-8 mt-6 space-y-4">
