...
<div class="px-6 mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
...
<div class="px-6 mt-6">
    ...
    <div class="bg-yellow-400 rounded-xl overflow-hidden shadow">
        ...
        <div class="grid min-w-[640px] grid-cols-3 text-center font-bold text-white py-3 border-b border-yellow-500">
        ...
        @forelse ($pengeluaran as $p)
            <div class="grid min-w-[640px] grid-cols-3 bg-white text-center py-4 border-b hover:bg-gray-50 transition-all">
