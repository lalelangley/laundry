...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="bg-yellow-400 px-8 py-6 rounded-b-3xl shadow-lg">
        ...
        <h1 class="text-2xl font-bold text-gray-900">Kelola Kasir</h1>
        <p class="text-sm text-gray-700 mt-1">
            Manajemen akun kasir dan hak akses
        </p>
    </div>
    ...
    <div class="px-8 py-6">
        <div class="flex gap-3 flex-wrap">
            <a href="{{ route('admin2.manager.hak.akses') }}"
               class="bg-yellow-400 hover:bg-yellow-500 text-gray-900 px-6 py-3 rounded-xl font-semibold transition flex items-center gap-2 shadow-md">
                ...
                <span>Setting Hak Akses Kasir</span>
            </a>
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
            ...
            <div class="px-8 py-5 bg-gradient-to-r from-gray-50 to-white border-b border-gray-200">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-lg font-bold text-gray-900">Daftar Kasir</h2>
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4 text-gray-600">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span>{{ $kasir->no_hp ?? '-' }}</span>
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-center">
                                    <form action="{{ route('admin2.manager.kasir.status', $kasir->id_kasir) }}" method="POST" class="inline-block">
                                        @csrf
                                        <select name="status"
                                ...
                                <td class="px-6 py-4 text-center">
                                    <a href="{{ route('admin2.manager.menu-role.akses', $kasir->id_kasir) }}"
                                       class="inline-flex items-center gap-2 bg-yellow-400 hover:bg-yellow-500 px-4 py-2 rounded-lg text-sm font-semibold text-gray-900 transition shadow-md">
