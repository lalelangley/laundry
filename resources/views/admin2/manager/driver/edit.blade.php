{{-- FE-DOC: Template frontend untuk resources/views/admin2/manager/driver/edit.blade.php. Tambahan komentar di file ini dipakai sebagai penjelas struktur Blade, Tailwind, CSS, dan JavaScript tanpa mengubah behavior. --}}
    ...
    <div class="px-12 py-10">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-5">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 mt-1">Update informasi driver: <strong>{{ $driver->nama_driver }}</strong></p>
                        </div>
                    </div>
                    <div class="bg-yellow-50 px-5 py-3 rounded-xl border border-yellow-200">
                        <p class="text-xs text-yellow-600 font-medium">ID Driver</p>
                        <p class="text-xl font-bold text-yellow-700">#{{ $driver->id_driver }}</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" 
                                       ...
                                       class="w-full border-2 border-gray-300 rounded-xl pl-14 pr-6 py-4 focus:border-yellow-400 focus:ring-4 focus:ring-yellow-100 transition outline-none @error('nama_driver') border-red-300 @enderror" 
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="tel" 
                                       name="no_telp"
                                       value="{{ old('no_telp', $driver->no_telp) }}"
                                       class="w-full border-2 border-gray-300 rounded-xl pl-24 pr-6 py-4 focus:border-yellow-400 focus:ring-4 focus:ring-yellow-100 transition outline-none @error('no_telp') border-red-300 @enderror"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <select name="status" 
                                        ...
                                        required>
                                    <option value="aktif" {{ old('status', $driver->status) === 'aktif' ? 'selected' : '' }}>✓ Aktif - Siap Bertugas</option>
                                    <option value="nonaktif" {{ old('status', $driver->status) === 'nonaktif' ? 'selected' : '' }}>✕ Nonaktif - Tidak Bertugas</option>
                                </select>
                        ...
                        <div class="lg:col-span-2 bg-gray-50 rounded-xl p-6 border border-gray-200">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="text-sm text-gray-600">
                                    ...
                                    <p>{{ $driver->updated_at->format('d M Y, H:i') }} WIB</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="mt-8 bg-amber-50 border-2 border-amber-200 rounded-xl p-6 flex items-start gap-4">
            ...
            <div class="text-sm text-amber-800">
                ...
                <p>Perubahan data driver akan langsung berlaku di sistem. Jika password diubah, driver harus menggunakan password baru untuk login. Pastikan data sudah benar sebelum menyimpan perubahan.</p>
            </div>
        </div>
    </div>
</div>
...
document.querySelector('form').addEventListener('submit', function(e) {
    ...
    const confirm = window.confirm(`Yakin ingin mengupdate data driver "${nama}"?`);
