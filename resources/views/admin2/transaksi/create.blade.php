{{-- FE-DOC: Template frontend untuk resources/views/admin2/transaksi/create.blade.php. Tambahan komentar di file ini dipakai sebagai penjelas struktur Blade, Tailwind, CSS, dan JavaScript tanpa mengubah behavior. --}}
...
<div class="p-4 space-y-6 pb-[180px]">
    ...
    <div class="bg-white rounded-3xl p-5 shadow-xl flex items-center justify-between">
        ...
        <a href="{{ route('admin2.transaksi.pelanggan') }}"
    ...
    <div class="bg-white rounded-3xl p-5 shadow-xl">
        <div class="flex items-center justify-between mb-5">
            ...
            <a href="{{ route('admin2.layanan.index', ['from' => 'transaksi']) }}"
                class="bg-yellow-400 px-4 py-3 rounded-2xl text-black font-bold shadow hover:bg-yellow-500 transition">
                Tambah Layanan
            </a>
        </div>
                ...
                <div class="group bg-gray-100 p-5 rounded-3xl shadow hover:shadow-lg transition">
                    ...
                    <div class="flex gap-4">
                        ...
                        <div class="flex flex-col items-end justify-between">
                            ...
                            <form 
                                action="{{ route('admin2.transaksi.remove', $index) }}" 
                                method="POST"
        ...
        <form id="checkoutForm" action="{{ route('admin2.transaksi.checkout') }}" method="POST">
            @csrf
            <div class="bg-white rounded-3xl p-5 shadow-xl mt-6">
                ...
                <script>
                    document.getElementById('keteranganTransaksi').addEventListener('input', function () {
                        fetch("{{ route('admin2.transaksi.updateKeterangan') }}", {
                            method: "POST",
                            headers: {
