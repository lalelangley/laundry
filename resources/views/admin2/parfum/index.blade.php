{{-- FE-DOC: Template frontend untuk resources/views/admin2/parfum/index.blade.php. Tambahan komentar di file ini dipakai sebagai penjelas struktur Blade, Tailwind, CSS, dan JavaScript tanpa mengubah behavior. --}}
@extends('layouts.master')

@section('title', 'Data Parfum')
            ...
            <div class="parfum-item bg-white p-5 rounded-2xl shadow-lg hover:shadow-xl transition-all hover:-translate-y-1 flex items-center gap-4"
                ...
                <div class="flex items-center gap-2">
                    ...
                    <form action="{{ route('admin2.parfum.destroy', $p->id_parfum) }}" method="POST" class="inline">
                        ...
                        @method('DELETE')
                        <button type="button"
                                onclick="confirmDelete(this, 'parfum')"
                                data-nama="{{ $p->nama_parfum }}"
