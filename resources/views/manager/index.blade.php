                    ...
                    <tbody class="divide-y divide-gray-200">
                        @forelse($admins as $admin)
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4 text-center">
                                    @if($adminLogin && $adminLogin->role_id == 1)
                                        <a href="{{ route('manager.akses', [
                                                'user_type' => 'admin',
                                                'user_id'   => $admin->id_admin
                                            ]) }}"
                                            class="inline-flex items-center gap-2 bg-yellow-400 hover:bg-yellow-500 px-4 py-2 rounded-lg text-sm font-semibold text-gray-900 transition">
                            ...
                            <tr>
                                <td colspan="5" class="px-8 py-10 text-center">
                                    <div class="flex flex-col items-center gap-2">
                                        ...
                                        <p class="text-sm text-gray-400">Tambahkan admin baru melalui tombol di atas</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
