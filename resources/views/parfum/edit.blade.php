{{-- FE-DOC: Template frontend untuk resources/views/parfum/edit.blade.php. Tambahan komentar di file ini dipakai sebagai penjelas struktur Blade, Tailwind, CSS, dan JavaScript tanpa mengubah behavior. --}}
...
<div class="p-4 bg-white min-h-screen">
    ...
    <form action="{{ route('parfum.update', $parfum->id_parfum) }}" method="POST">
        @csrf
        @method('PUT')
